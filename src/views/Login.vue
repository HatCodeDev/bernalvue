    ...
    <div class="row mt-5">
        <div class="col-md-12 ">
            <div class="card login-card border rounded-0 shadow-lg">
                <div class="row g-0">
                  <div class="col-md-5">
                    <img :src="loginImage" class="img-fluid h-100" alt="Login Image">
                  </div>
                  <div class="col-md-7">
                    ...
                    <div class="card-body p-4">
                      <form @submit.prevent="$event => authStore.login(form)">
                        <div class="input-group mb-3">
                          ...
                          <input autofocus type="email" v-model="form.email" placeholder="Email" class="form-control" required>
                        </div>
                        ...
                        <div class="text-center">
                          <router-link :to="{ path: 'register' }" class="text-dark">¿No tienes una cuenta? Regístrate</router-link>
                        </div>
                      </form>
                    </div>
                  </div>
